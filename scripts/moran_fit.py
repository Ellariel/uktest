...
variables = ["pv_cap_fit", "pv_inst_fit", "pv_cap_per_inst_fit"]
...
if not os.path.exists(moran_results_file):
    ...
    moran_results = {
        "pv_cap_fit": pv_cap_moran_results,
        "pv_inst_fit": pv_inst_moran_results,
        "pv_cap_per_inst_fit": pv_cap_per_inst_moran_results,
    }
    ...
    with open(moran_results_file, "rb") as f:
        ...
        pv_cap_moran_results, pv_inst_moran_results, pv_cap_per_inst_moran_results = (
            moran_results["pv_cap_fit"],
            moran_results["pv_inst_fit"],
...
labels = {
    ...
    "pv_cap_fit": "PV installed capacity",
    "pv_inst_fit": "PV installations",
